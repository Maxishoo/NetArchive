package com.example.netarchive.ui.ContactListScreen
...
fun ContactListScreenPreview() {
        ...
        val fakeContacts = listOf(
            Contact(id = 1, username = "Иванов Иван", "123", "ass", "ass", "ass", "ass", "ewe"),
            Contact(id = 2, username = "Петров Дмитрий", "123", "ass", "ass", "ass", "ass", "ewe")
        )
        LazyColumn {
            items(fakeContacts) { contact ->
